...
package com.techsamuel.roadsideprovider.location_update;
...
public class LocationUpdatesService extends Service {
    ...
    //com.techsamuel.roadsideprovider.location_update
    @SuppressWarnings("deprecation")
    @Override
    ...
    private Notification getNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.ic_baseline_message_24, getString(R.string.launch_app),
    ...
    private void SavetoServer() {
        ProviderLocation providerLocation=new ProviderLocation(latitude,longitude);
        firebaseDatabase.getReference(DatabaseReferenceName.PROVIDER_LOCATION).child(String.valueOf(Config.ORDER_ID)).setValue(providerLocation).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
